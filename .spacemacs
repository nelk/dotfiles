...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     (org
      :variables
      org-directory (expand-file-name "~/notes_alex_klen")
...
before packages are loaded."
  ...
  ;   (add-to-list 'org-modules 'org-noter)
  ;   (add-to-list 'org-modules 'org-noter-pdftools)
    (setq org-capture-templates '(
                                  ("p" "Protocol" entry (file+headline "~/notes_alex_klen/notes.org" "Inbox")
                                   "* %^{Title}\nSource: %u, %c\n #+BEGIN_QUOTE\n%i\n#+END_QUOTE\n\n\n%?")
                                  ("L" "Protocol Link" entry (file+headline "~/notes_alex_klen/notes.org" "Inbox")
                                   "* %? [[%:link][%:description]] \nCaptured On: %U"))))
